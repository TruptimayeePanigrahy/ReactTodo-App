...
export default function Mydata() {
    ...
    const handleEditSubmit = (id,updatedPost) => {
        ...
        fetch(`https://reactnotesapp-bffb.onrender.com/post/post/${id}`, {
            method: "PUT",
    ...
    function deletetodos(ele){
        ...
        fetch(`https://reactnotesapp-bffb.onrender.com/post/post/${ele}`,{
            method:"DELETE",
    ...
    function fetchdata(){
        fetch(`https://reactnotesapp-bffb.onrender.com/post/${user._id}`)
        .then((res)=>res.json())
        .then((data)=>{
            if(data.msg){
                toast.success(data.msg, {
